...
public final class CustomActivityOnCrash {
    ...
    public static final String PACKAGE_NAME = "com.bezets.cityappar";

    //Extras passed to the error activity
    private static final String EXTRA_RESTART_ACTIVITY_CLASS = PACKAGE_NAME + ".EXTRA_RESTART_ACTIVITY_CLASS";
    private static final String EXTRA_SHOW_ERROR_DETAILS = PACKAGE_NAME +".EXTRA_SHOW_ERROR_DETAILS";
    private static final String EXTRA_STACK_TRACE = PACKAGE_NAME +".EXTRA_STACK_TRACE";
    private static final String EXTRA_IMAGE_DRAWABLE_ID = PACKAGE_NAME +".EXTRA_IMAGE_DRAWABLE_ID";
    private static final String EXTRA_EVENT_LISTENER = PACKAGE_NAME +".EXTRA_EVENT_LISTENER";

    //General constants
    private static final String INTENT_ACTION_ERROR_ACTIVITY = PACKAGE_NAME + ".ERROR";
    private static final String INTENT_ACTION_RESTART_ACTIVITY = PACKAGE_NAME + ".RESTART";
    private static final String CAOC_HANDLER_PACKAGE_NAME = PACKAGE_NAME;
    ...
    private static int defaultErrorActivityDrawableId = R.drawable.ic_android_robot_mobile_mood_emoji_crash_bug_dead;
    ...
    public static int getDefaultErrorActivityDrawableIdFromIntent(Intent intent) {
        return intent.getIntExtra(CustomActivityOnCrash.EXTRA_IMAGE_DRAWABLE_ID, R.drawable.ic_android_robot_mobile_mood_emoji_crash_bug_dead);
    }
    ...
    /**
     * Returns the description_activity_menu activity class that the error activity must launch when a crash occurs.
     *
     * @return The class, or null if not set.
     */
    ...
    /**
     * Sets the description_activity_menu activity class that the error activity must launch when a crash occurs.
