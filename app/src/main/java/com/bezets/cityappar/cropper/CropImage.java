...
public final class CropImage {
     ...
     * Use "pick_image_intent_chooser_title" string resource to override pick chooser vTitle.
     *
     ...
     * Use "pick_image_intent_chooser_title" string resource to override chooser vTitle.
     *
     ...
     *
     * @param context used to access Android APIs, like content resolve, it is your activity/fragment/widget.
     * @param title the vTitle to use for the chooser UI
    ...
    public static Intent getPickImageChooserIntent(@NonNull Context context, CharSequence title, boolean includeDocuments) {
        ...
        if (galleryIntents.size() == 0) {
            // if no_image intents found for get-content try pick intent action (Huawei P9).
     ...
     * @return true - required permission are not granted, false - either no_image need for permissions or they are granted
     */
    ...
    public static final class ActivityBuilder {
        ...
        /**
         * the vTitle of the {@link CropImageActivity}.<br>
         * <i>Default: ""</i>
         */
         ...
         * Note: if rotation is disabled this option has no_image effect.<br>
         * <i>Default: false</i>
         */
