...
public class CropOverlayView extends View {
    ...
    /**
     * The Handle that is currently pressed; null if no_image Handle is pressed.
     */
    ...
    private void initCropWindow() {
        ...
        if (mInitialCropWindowRect.width() > 0 && mInitialCropWindowRect.height() > 0) {
            ...
            if (bitmapAspectRatio > mTargetAspectRatio) {
                ...
                // Limits the aspect ratio to no_image less than 40 wide or 40 tall
     ...
     * if press is far from crop window then no_image move handler is returned (null).
     */
